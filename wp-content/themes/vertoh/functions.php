...
// Get Theme Options
    $ef_options = EF_Event_Options::get_theme_options();
    wp_enqueue_style('vertoh-font-lato', 'http://fonts.googleapis.com/css?family=Lato:300,400,900,400italic');
...
// Color Schemes
    ...
    if (isset($color_scheme) && $color_scheme != 'basic') {
        wp_enqueue_style($color_scheme . '-scheme', get_template_directory_uri() . '/css/schemes/' . $color_scheme . '/layout.css', array('vertoh-style'));
    }
...
// Scripts
    ...
    wp_enqueue_script('vertoh-googlemaps', 'http://maps.google.com/maps/api/js?sensor=true', false, false, true);
