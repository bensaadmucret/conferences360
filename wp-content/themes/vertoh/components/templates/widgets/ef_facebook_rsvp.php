        ...
        <div class="section-content row">
            <div class='col-sm-4 col-xs-12'>
                <div class="social-box">
                    <span class="number"><?php echo $args['rsvpinvited']['summary']['attending_count']; ?></span>
                    <div>
            ...
            <div class='col-sm-4 col-xs-12'>
                <div class="social-box">
                    <span class="number"><?php echo $args['rsvpinvited']['summary']['maybe_count']; ?></span>
                    <div>
            ...
            <div class='col-sm-4 col-xs-12'>
                <div class="social-box">
                    <span class="number"><?php echo $args['rsvpinvited']['summary']['declined_count']; ?></span>
                    <div>
