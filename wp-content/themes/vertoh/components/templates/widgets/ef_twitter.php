    ...
    <div class="container">
        ...
        <div class="section-content">
            ...
            <footer class="section-footer">
                <iframe id="twitter-widget-0" src="http://platform.twitter.com/widgets/tweet_button.1384994725.html#_=1385458781193&amp;button_hashtag=<?php echo $args['twitterhash']; ?>&amp;count=none&amp;id=twitter-widget-0&amp;lang=en&amp;size=m&amp;type=hashtag" class="twitter-hashtag-button twitter-tweet-button twitter-hashtag-button twitter-count-none" title="Twitter Tweet Button" data-twttr-rendered="true" style="width: <?php echo(!empty($args['buttonwidth']) ? $args['buttonwidth'] : '120'); ?>px; height: 20px; margin:0; padding:0; border:none;"></iframe>
            </footer>
        </div>
    </div>
</section>